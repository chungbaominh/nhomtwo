...
using nhomtwo.Module.BusinessObjects;
using Microsoft.Extensions.DependencyInjection;

namespace nhomtwo.Module.DatabaseUpdate;
...
#if !RELEASE
        if (TenantName == null) {
            _ = CreateTenant("company1.com", "nhomtwo_company1");
            _ = CreateTenant("company2.com", "nhomtwo_company2");
